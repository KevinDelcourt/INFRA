...
import irit.infra.directory.ReferenceAgentListener;

import java.util.List;

public class ClassicStrategy implements SchedulingStrategy {
    ...
    public List<ReferenceAgentListener> getReferenceAgentListeners() {
        return null;
    }
